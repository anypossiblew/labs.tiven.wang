...
let ChordComponent = class ChordComponent {
    ...
    create() {
        ...
        let radius = this.width / 2 - this.margin - this.chordBorderWidth;
        let dArc = Object(d3__WEBPACK_IMPORTED_MODULE_2__["arc"])()
            .innerRadius(radius)
            .outerRadius(radius + this.chordBorderWidth);
        let dRibbon = Object(d3__WEBPACK_IMPORTED_MODULE_2__["ribbon"])().radius(radius);
