...
var routes = [{
        ...
        children: [
            ...
            {
                path: 'correlation',
                loadChildren: function () { return Promise.all(/*! import() | correlation-correlation-module */[__webpack_require__.e("default~correlation-correlation-module~flow-flow-module~parts-parts-module"), __webpack_require__.e("correlation-correlation-module")]).then(__webpack_require__.bind(null, /*! ./correlation/correlation.module */ "./src/app/pages/d3/correlation/correlation.module.ts")).then(function (m) { return m.CorrelationModule; }); }
            },
            {
                path: 'parts',
                loadChildren: function () { return Promise.all(/*! import() | parts-parts-module */[__webpack_require__.e("default~correlation-correlation-module~flow-flow-module~parts-parts-module"), __webpack_require__.e("parts-parts-module")]).then(__webpack_require__.bind(null, /*! ./parts/parts.module */ "./src/app/pages/d3/parts/parts.module.ts")).then(function (m) { return m.PartsModule; }); }
            },
            {
                path: 'map',
                loadChildren: function () { return __webpack_require__.e(/*! import() | map-map-module */ "map-map-module").then(__webpack_require__.bind(null, /*! ./map/map.module */ "./src/app/pages/d3/map/map.module.ts")).then(function (m) { return m.MapModule; }); }
            },
            {
                path: 'flow',
                loadChildren: function () { return Promise.all(/*! import() | flow-flow-module */[__webpack_require__.e("default~correlation-correlation-module~flow-flow-module~parts-parts-module"), __webpack_require__.e("flow-flow-module")]).then(__webpack_require__.bind(null, /*! ./flow/flow.module */ "./src/app/pages/d3/flow/flow.module.ts")).then(function (m) { return m.FlowModule; }); }
            }
        ]
    }];
