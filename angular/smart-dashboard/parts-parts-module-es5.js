...
var CirclePackingComponent = /** @class */ (function () {
    function CirclePackingComponent(httpClient) {
    ...
    CirclePackingComponent.prototype.ngOnInit = function () {
    };
    CirclePackingComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        ...
        this.httpClient.get('https://raw.githubusercontent.com/d3/d3-hierarchy/v1.1.8/test/data/flare.json')
            ...
            _this.createDiagram(data);
        });
    };
    CirclePackingComponent.prototype.createDiagram = function (data) {
        /**
         * https://github.com/d3/d3-hierarchy#pack
         */
        this.root = Object(d3__WEBPACK_IMPORTED_MODULE_3__["pack"])()
            .size([this.width - 2, this.height - 2])
            .padding(3)(Object(d3__WEBPACK_IMPORTED_MODULE_3__["hierarchy"])(data).sum(function (d) { return d.value; }).sort(function (a, b) { return b.value - a.value; }));
        this.dataGroups = Array.from(Object(d3_array__WEBPACK_IMPORTED_MODULE_4__["group"])(this.root.descendants(), function (d) { return d.height; }));
        // Initial view to root
        this.zoom(this.root);
    };
    CirclePackingComponent.prototype.circleClick = function (d) {
        this.zoom(d);
    };
    CirclePackingComponent.prototype.zoomBack = function () {
        this.zoom(this.root);
    };
    CirclePackingComponent.prototype.zoom = function (d) {
        if (this.focus !== d) {
            this.focus = d;
            this.zoomTo([this.focus.x, this.focus.y, this.focus.r * 2]);
        }
    };
    CirclePackingComponent.prototype.zoomTo = function (v) {
...
var SunburstComponent = /** @class */ (function () {
    function SunburstComponent(httpClient) {
        this.httpClient = httpClient;
        // SVG attributes
        this.width = 0;
        this.height = 0;
    ...
    SunburstComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        ...
        this.httpClient.get('https://raw.githubusercontent.com/d3/d3-hierarchy/v1.1.8/test/data/flare.json')
            .subscribe(function (data) {
            _this.create(_this.partition(data));
        });
    };
    SunburstComponent.prototype.partition = function (data) {
        var root = Object(d3__WEBPACK_IMPORTED_MODULE_3__["hierarchy"])(data)
            .sum(function (d) { return d.value; })
            .sort(function (a, b) { return b.value - a.value; });
        return Object(d3__WEBPACK_IMPORTED_MODULE_3__["partition"])()
            .size([2 * Math.PI, root.height + 1])(root);
    };
    SunburstComponent.prototype.create = function (data) {
        var _this = this;
        this.root = data;
        ...
        var formatter = Object(d3__WEBPACK_IMPORTED_MODULE_3__["format"])(",d");
        data.each(function (d) {
            ...
            d.title = d.ancestors().map(function (d) { return d.data.name; }).reverse().join("/") + "\n" + formatter(d.value);
            _this.reCalculate(d);
        });
    };
    SunburstComponent.prototype.reCalculate = function (d) {
    ...
    SunburstComponent.prototype.arc = function () {
        var _this = this;
        return Object(d3__WEBPACK_IMPORTED_MODULE_3__["arc"])()
            ...
            .innerRadius(function (d) { return d.y0 * _this.radius; })
            .outerRadius(function (d) { return Math.max(d.y0 * _this.radius, d.y1 * _this.radius - 1); });
    };
    SunburstComponent.prototype.arcVisible = function (d) {
        return d.y1 <= 3 && d.y0 >= 1 && d.x1 > d.x0;
    };
    SunburstComponent.prototype.labelVisible = function (d) {
        return d.y1 <= 3 && d.y0 >= 1 && (d.y1 - d.y0) * (d.x1 - d.x0) > 0.03;
    };
    SunburstComponent.prototype.labelTransform = function (d) {
        var x = (d.x0 + d.x1) / 2 * 180 / Math.PI;
        var y = (d.y0 + d.y1) / 2 * this.radius;
        return "rotate(" + (x - 90) + ") translate(" + y + ",0) rotate(" + (x < 180 ? 0 : 180) + ")";
    };
    SunburstComponent.prototype.dClick = function (p) {
        var _this = this;
        if (!p.children)
            return;
    ...
    SunburstComponent.prototype.zoomBack = function () {
