...
var NetworkGraphComponent = /** @class */ (function () {
    function NetworkGraphComponent() {
    }
    NetworkGraphComponent.prototype.ngOnInit = function () {
    };
...
var anyecharts = echarts__WEBPACK_IMPORTED_MODULE_4__;
var indices = {
    name: 0,
    group: 1,
    id: 16
...
var groupCategories = [];
var groupColors = [];
var ParallelAxisComponent = /** @class */ (function () {
    function ParallelAxisComponent(httpClient, nbThemeService) {
    ...
    ParallelAxisComponent.prototype.ngOnInit = function () {
    };
    ParallelAxisComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        ...
        this.httpClient.get('/localService/examples/nutrients.json')
            ...
            _this.chartOptions.next(_this.getOption(data));
        });
    };
    ParallelAxisComponent.prototype.normalizeData = function (originData) {
        var groupMap = {};
    ...
    ParallelAxisComponent.prototype.getOption = function (data) {
        var lineStyle = {
            normal: {
                width: 0.5,
                opacity: 0.05
    ...
    ParallelAxisComponent.prototype.ngOnDestroy = function () {
        this.destroy$.next();
